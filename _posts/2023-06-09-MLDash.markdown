...
application that span the development process(documentation added throughout development):
    ...
    1.  [Origin][ml-origin]: (The Catpole program and the Dashboard program, before any integration or upgrades)
    2.  [Enhancement 1][ml-enhancea]: Software Design and Enginering (Requirements Analysis, Software Integration, Interface Design)
    3.  [Enhancement 2][ml-enhanceb]: Algorithms and Data Structure (optimization of speed and memory consumption)
    4.  [Enhancement 3][ml-enhancec]: Databases (Expansion of database and data handling capabilities)
    5.  [MLDash][ml-enhanced]: (The most recent iteration of the final artifact, which includes security upgrades)
